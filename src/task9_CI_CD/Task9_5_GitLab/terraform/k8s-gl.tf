...
locals {
  ...
  sa_name               = "srv-acc-k8s"            # Set the service account name.
  registry_name         = "my-reestr"            # Set the name of Yandex Container Registry.
}
...
resource "yandex_vpc_security_group_rule" "a5050" {
